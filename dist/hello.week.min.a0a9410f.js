...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/hello.week.min.js":[function(require,module,exports) {
...
!function (t) {
  ...
  var i = s(1),
    ...
    return Object.defineProperty(t, "cssClasses", {
      ...
      var s = this,
          i = function i(_i) {
        a.daysHighlight[_i].days[0] instanceof Array ? a.daysHighlight[_i].days.map(function (a, n) {
          e.timestamp >= new Date(new Date(a[0]).setHours(0, 0, 0, 0)).getTime() && e.timestamp <= new Date(new Date(a[1]).setHours(0, 0, 0, 0)).getTime() && s.setStyleDayHighlight(t, _i, e);
        }) : a.daysHighlight[_i].days.map(function (a) {
          new Date(new Date(e.timestamp).setHours(0, 0, 0, 0)).getTime() === new Date(new Date(a).setHours(0, 0, 0, 0)).getTime() && s.setStyleDayHighlight(t, _i, e);
        });
      },
          a = this;

      for (var n in this.daysHighlight) {
        i(n);
      }
      ...
      for (var e = this.options.weekStart; e < this.langs.daysShort.length; e++) {
        t.push(e);
      }

      for (e = 0; e < this.options.weekStart; e++) {
        t.push(e);
      }
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/hello.week.min.js"], null)
//# sourceMappingURL=/hello.week.min.a0a9410f.js.map